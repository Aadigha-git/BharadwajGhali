...
export default function AboutPage() {
  return (
    <Container>
      <div className="mt-4 py-8 sm:py-12 lg:py-16 space-y-8 sm:space-y-12 lg:space-y-16">
        <Section>
          <motion.h1
        ...
        <Section>
          <motion.h2
            className="text-2xl sm:text-xs lg:text-[28px] font-medium"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="space-y-1.5 sm:space-y-2 text-sm sm:text-xs lg:text-[16px] text-muted-foreground"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.2 }}
            viewport={{ once: true }}
